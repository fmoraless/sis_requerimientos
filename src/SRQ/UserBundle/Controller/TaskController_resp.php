...
class TaskController extends Controller
{
    ...
    public function customAction(Request $request)
    {
        ...
        $em = $this->getDoctrine()->getManager();
        $dql = "SELECT t FROM SRQUserBundle:Task t JOIN t.user u WHERE u.id = :idUser ORDER BY t.id DESC";
        ...
        $updateForm = $this->createCustomForm(':TASK_ID', 'PUT', 'srq_task_process');
        
        return $this->render('SRQUserBundle:Task:custom.html.twig', array('pagination' => $pagination, 'update_form' => $updateForm->createView()));
    }
    ...
    public function processAction($id, Request $request)
    {
        ...
        $form = $this->createCustomForm($task->getId(), 'PUT', 'srq_task_process');
    ...
    public function viewAction($id)
    {
        ...
        return $this->render('SRQUserBundle:Task:view.html.twig', array('task' => $task, 'user' => $user, 'delete_form' => $deleteForm->createView()));
    }
    ...
    public function editAction($id)
    {
        ...
        return $this->render('SRQUserBundle:Task:edit.html.twig', array('task' => $task, 'form' => $form->createView()));
    }
